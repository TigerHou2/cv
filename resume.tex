...
\begin{document}
	...
	\begin{tabularx}{\linewidth}{@{}l X@{}}
		...
		\multicolumn{2}{@{}l@{}}{\qquad University of Illinois Urbana-Champaign} \\
		\multicolumn{2}{@{}l@{}}{\qquad Thesis: Autonomous Lost in Space and Time State Determination using Periodic Variable Stars} \\[3.75pt]
	...
	\section{Skills}
	\begin{tabularx}{\linewidth}{@{}l X@{}}
		Technical  &  celestial navigation, orbit determination, batch filtering, Kalman filtering, Monte Carlo simulation, spacecraft navigation modeling \\[3.75pt]
		Collaboration  &  technical/proposal writing, MS Office suite, \LaTeX, Git, GitHub, Trello \\[3.75pt]
		Programming  &  proficient: Python, C/C++, MATLAB \enspace$|$\quad beginner: Simulink, Javascript, Julia \\[3.75pt]
	\end{tabularx}
	...
	\begin{tabularx}{\linewidth}{ @{} L{0.86\linewidth} @{}X@{} r @{} }
		...
		\begin{minipage}[t]{\linewidth}
			\begin{itemize}
				...
				\item Collaborated with colleagues to create navigation simulation tools in Python to assess the feasibility of replacing DSN tracking with celestial navigation on OSIRIS-APEX.
	...
	\begin{tabularx}{\linewidth}{ @{} L{0.86\linewidth} @{}X@{} r @{} }
		...
		\multirow{2}{*}{\makecell[r]{2022, 2023}} \\[3.75pt]
		\begin{minipage}[t]{\linewidth}
			\begin{itemize}
