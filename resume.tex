		...
		\multicolumn{2}{@{}X@{}}{
			\begin{minipage}[t]{\linewidth}
				\begin{itemize}
					...
					\item Assessed navigation performance through simulations and Monte Carlo analysis. 
		...
		\multicolumn{2}{@{}X@{}}{
			\begin{minipage}[t]{\linewidth}
				\begin{itemize}
					...
					\item Led a team of 10+ students to develop a reusable crewed lunar lander concept. 
				\end{itemize}
			\end{minipage}
		} & \hfill
	\end{tabularx}
