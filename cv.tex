...
\setlist[itemize]{
	nosep,
	label=-,%\ding{252},%\raisebox{0.5ex}{\tiny$\blacktriangleright$},
	after=\strut, 
	leftmargin=1.5em, 
	itemsep=3pt
}
...
\NewDocumentEnvironment{Awards}{mmm +b}{
...
%for publications
\usepackage[backend=biber,style=ieee,sorting=none,style=numeric,maxbibnames=99,minbibnames=99]{biblatex}
...
\begin{document}
	...
	\begin{Awards}
		{Best Student Paper, 46\textsuperscript{th} AAS GN\&C Conference}{2024}
